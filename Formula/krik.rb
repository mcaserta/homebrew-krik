class Krik < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mcaserta/krik/releases/download/v0.1.27/kk-macos-aarch64"
      sha256 "fa113cecc62d39f33140b0a6cccbcbb20e323b1c3a9b356bae7b6d57fd877ab1"
    else
      url "https://github.com/mcaserta/krik/releases/download/v0.1.27/kk-macos-x86_64"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/mcaserta/krik/releases/download/v0.1.27/kk-linux-x86_64"
